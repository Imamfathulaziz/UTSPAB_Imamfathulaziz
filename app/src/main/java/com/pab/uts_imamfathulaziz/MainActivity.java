        ...
        btnDaftar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nama.trim().equals("")){
                    ...
                    Toast.makeText(MainActivity.this, "Pilih informasi pendaftaran!!!", Toast.LENGTH_SHORT).show();
                }
                if (!(nama.trim().equals("")) && !(nomor.trim().equals("")) && (cbFB.isChecked() || cbWEB.isChecked() || cbIG.isChecked())){
                    info = String.join(", ", hsInfo);

                    Intent intent = new Intent(MainActivity.this, MainActivity2.class);
                    intent.putExtra("aNama", nama);
                    intent.putExtra("aNomor", nomor);
                    intent.putExtra("aInfo", "Informasi Pendaftaran Dari :\n" + info);
